...
│  │                                                                         │    │
│  │  ┌──────────────┐ ┌──────────────┐ ┌──────────────┐                  │    │
│  │  │  Residents   │ │ Upload Image │ │  Settings    │                  │    │
│  │  │              │ │              │ │              │                  │    │
│  │  │ • Registry   │ │ • Manual     │ │ • Config     │                  │    │
│  │  │ • Contacts   │ │  Detection   │ │ • Preferences│                  │    │
│  │  │ • SMS link   │ │              │ │              │                  │    │
│  │  └──────────────┘ └──────────────┘ └──────────────┘                  │    │
│  └─────────────────────────────────────────────────────────────────────────┘    │
│                                                                                   │
...
│  │                                                                           │   │
│  │  ┌────────────────────┐  ┌────────────────────┐  ┌──────────────────┐  │   │
│  │  │ User Routes        │  │ Notification Routes│  │ Resident Routes  │  │   │
│  │  │ /api/users         │  │ /api/notifications│  │ /api/residents   │  │   │
│  │  │                    │  │                    │  │                  │  │   │
│  │  │ • User management  │  │ • Send alerts      │  │ • CRUD residents │  │   │
│  │  │ • Roles/Permissions│  │ • Notification log │  │ • Search         │  │   │
│  │  │ • Profile          │  │ • Preferences      │  │                  │  │   │
│  │  │ • Audit            │  │ • Multi-channel    │  │                  │  │   │
│  │  └────────────────────┘  └────────────────────┘  └──────────────────┘  │   │
│  │                                                                           │   │
...
- Dashboard, Cameras, Vehicles, Analytics
- Tickets, Violations, Warnings, Users
- Residents, Upload, Settings, Audit Logs
