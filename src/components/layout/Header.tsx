...
import { Bell, LogOut, User, AlertTriangle, Camera } from 'lucide-react';
                ...
                <div className="max-h-96 overflow-y-auto">
                  {notifications.map((notification) => {
                    ...
                    return (
                      <DropdownMenuItem
                        key={notification.id}
                        className="flex flex-col items-start gap-2 p-3 cursor-pointer hover:bg-muted/50 border-b border-border/40 last:border-b-0"
                      ...
                      >
                        <div className="flex items-start gap-2 w-full">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-foreground/90 whitespace-normal leading-5">{notification.message}</p>
                            <div className="flex flex-wrap items-center gap-2 mt-2 text-[11px] text-muted-foreground">
                              ...
                              {notification.reason && (
                                <span className="text-warning">Reason: {notification.reason}</span>
                              )}
                            </div>
